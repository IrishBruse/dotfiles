export function printHelp(): void {
  console.log(
    [
      ...
      "  (default)      Prints `create` or `update` on the first line, then runs that command (open PR on branch → update)",
      "",
      "Work (optional):",
      ...
      "                   (no agent). Combinable with --opus / --codex. With no subcommand, first line is still create|update, then the chosen command runs.",
