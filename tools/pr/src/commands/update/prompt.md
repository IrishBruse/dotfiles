...
- The CLI already prefetched PR data into the **workspace root** (`view.json`, `commits.txt`, `checks.json`, `comments.md`, `files.json`, `diff.patch`, optionally **`KEY-123.md`** ticket files like `NOVACORE-39309.md`). Use those files — do not run `gh` or the GitHub API again to fetch PR content.
