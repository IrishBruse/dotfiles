export function printHelp(): void {
  console.log(
    [
      ...
      "",
      "  pr fix checks CI on the current PR, injects failed workflow logs,",
      "  and runs the pr-fix skill to repair merge-blocking failures.",
      "",
      "Commands:",
      "  fix          Fix failed PR checks and workflows",
      "",
      "Options:",
