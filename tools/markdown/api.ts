 ...
 *
 * Headings, paragraphs, lists, tables, blockquotes, rules, and fenced or indented
 * code blocks are styled for TTY output. Inline emphasis, code spans, and links
 * (including OSC 8 click targets) are supported.
 *
