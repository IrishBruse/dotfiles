You are executing a **pull request review** (default `pr`, `pr review`, or `pr update`). Follow this document exactly: read the dynamic assignment first, then run the workflow (`gh` commands, structure, tone). This is a full review-and-approve pass — assess correctness and risk, give a clear verdict, and state merge readiness.

{{prLine}}

{{mission}}{{hintBlock}}{{jiraBlock}}
