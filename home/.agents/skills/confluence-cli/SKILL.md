---
name: confluence-cli
description: 'Runs the `confluence` CLI (plus Confluence MCP for what the CLI cannot do) for local `confluence/` markdown and live pages.
  Use when working on Confluence pull/push/sync, page URLs, or CQL search.'
