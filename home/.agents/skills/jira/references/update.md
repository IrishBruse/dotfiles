...
This route updates existing Jira issues only after investigation, an exact proposed change, and explicit Jira-write confirmation.
...
6. Stop for explicit confirmation before editing Jira.
...
| Jira write | Any edit, link, transition, comment, or reparent | Stop and ask for explicit confirmation |
...
- Do not reparent, transition, close, or split without explicit approval.
