...
Optionally draft child files, then create Jira Tasks, Sub-tasks, or Stories only after explicit confirmation.
...
- Do not reparent, close, or replace Jira issues without explicit approval.
...
- Creating Jira issues without stop gate 2.
