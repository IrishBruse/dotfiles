...
- [Jest React Testing Examples](#jest-react-testing-examples)
  - [Table of Contents](#table-of-contents)
  - [1.
    Basic Component Testing](#1-basic-component-testing)
    - [Component: Button](#component-button)
    - [Tests](#tests)
  - [2.
    Form Testing with Validation](#2-form-testing-with-validation)
    - [Component: LoginForm](#component-loginform)
    - [Tests](#tests-1)
  - [3.
    Async API Data Fetching](#3-async-api-data-fetching)
    - [Component: UserProfile](#component-userprofile)
    - [Tests with MSW](#tests-with-msw)
  - [4.
    User Authentication Flow](#4-user-authentication-flow)
    - [Component: AuthProvider \& useAuth](#component-authprovider--useauth)
    - [Tests](#tests-2)
  - [5.
    Modal and Dialog Testing](#5-modal-and-dialog-testing)
    - [Component: Modal](#component-modal)
    - [Tests](#tests-3)
  - [6.
    Dropdown and Select Testing](#6-dropdown-and-select-testing)
    - [Component: Dropdown](#component-dropdown)
    - [Tests](#tests-4)
  - [7.
    Testing Custom Hooks](#7-testing-custom-hooks)
    - [Hook: useLocalStorage](#hook-uselocalstorage)
    - [Tests](#tests-5)
  - [8.
    Testing with React Router](#8-testing-with-react-router)
    - [Component: Navigation](#component-navigation)
    - [Tests](#tests-6)
  - [9.
    Testing with Redux](#9-testing-with-redux)
    - [Component: TodoList with Redux](#component-todolist-with-redux)
    - [Tests](#tests-7)
  - [10.
    Testing with Context API](#10-testing-with-context-api)
    - [Component: Theme Context](#component-theme-context)
    - [Tests](#tests-8)
  - [11.
    File Upload Component](#11-file-upload-component)
    - [Component: FileUpload](#component-fileupload)
    - [Tests](#tests-9)
  - [12.
    Autocomplete Component](#12-autocomplete-component)
    - [Component: Autocomplete](#component-autocomplete)
    - [Tests](#tests-10)
  - [13.
    Infinite Scroll List](#13-infinite-scroll-list)
    - [Component: InfiniteScrollList](#component-infinitescrolllist)
    - [Tests](#tests-11)
  - [14.
    Error Boundary Testing](#14-error-boundary-testing)
    - [Component: ErrorBoundary](#component-errorboundary)
    - [Tests](#tests-12)
  - [15.
    Accessibility Testing](#15-accessibility-testing)
    - [Component: AccessibleForm](#component-accessibleform)
    - [Tests](#tests-13)
  - [16.
    Testing Timers and Intervals](#16-testing-timers-and-intervals)
    - [Component: Countdown](#component-countdown)
    - [Tests](#tests-14)
  - [17.
    Testing WebSocket Integration](#17-testing-websocket-integration)
    - [Component: ChatRoom](#component-chatroom)
    - [Tests](#tests-15)
  - [18.
    Multi-step Form Wizard](#18-multi-step-form-wizard)
    - [Component: FormWizard](#component-formwizard)
    - [Tests](#tests-16)
  - [Summary](#summary)
